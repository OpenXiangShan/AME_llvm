...
; RUN: llc -mtriple=riscv32 -mattr=+boscztt,+boscztt-ame-gem5 -verify-machineinstrs < %t.ame.ll | FileCheck %s
...
; RUN: llc -mtriple=riscv32 -mattr=+boscztt -verify-machineinstrs < %s | FileCheck %s
; RUN: llc -mtriple=riscv32 -mattr=+boscztt -O0 -verify-machineinstrs < %s | FileCheck %s

; Check the complete instruction operands and return at both optimization levels.
target datalayout = "e-m:e-p:32:32-i64:64-n32-S128"
target triple = "riscv32"

declare i32 @llvm.riscv.ztt.ame.acquire.i32(i32)
; CHECK-LABEL: test_ame_acquire:
; CHECK: ame.acquire a0, a0{{$}}
; CHECK-NEXT: ret{{$}}
define i32 @test_ame_acquire(i32 %p0) {
  %r = call i32 @llvm.riscv.ztt.ame.acquire.i32(i32 %p0)
  ret i32 %r
}
...
declare i32 @llvm.riscv.ztt.agettyp.i32.triscv.ztt.acc_i32_8_8t(target("riscv.ztt.acc", i32, 8, 8))
; CHECK-LABEL: test_agettyp:
; CHECK: agettyp a0, acc0{{$}}
; CHECK-NEXT: ret{{$}}
define i32 @test_agettyp(target("riscv.ztt.acc", i32, 8, 8) %p0) {
  %r = call i32 @llvm.riscv.ztt.agettyp.i32.triscv.ztt.acc_i32_8_8t(target("riscv.ztt.acc", i32, 8, 8) %p0)
  ret i32 %r
}

declare target("riscv.ztt.acc", i32, 8, 8) @llvm.riscv.ztt.asettyp.triscv.ztt.acc_i32_8_8t.i32(target("riscv.ztt.acc", i32, 8, 8), i32)
; CHECK-LABEL: test_asettyp:
; CHECK: asettyp acc0, a0{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.acc", i32, 8, 8) @test_asettyp(i32 %p0) {
  %r = call target("riscv.ztt.acc", i32, 8, 8) @llvm.riscv.ztt.asettyp.triscv.ztt.acc_i32_8_8t.i32(target("riscv.ztt.acc", i32, 8, 8) undef, i32 %p0)
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mabsdiff.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mabsdiff_ew_x:
; CHECK: mabsdiff.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mabsdiff_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mabsdiff.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.madd.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_madd_ew_x:
; CHECK: madd.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_madd_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.madd.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mand.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mand_ew_x:
; CHECK: mand.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mand_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mand.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mandnot.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mandnot_ew_x:
; CHECK: mandnot.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mandnot_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mandnot.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mcmpge.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mcmpge_ew_x:
; CHECK: mcmpge.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mcmpge_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mcmpge.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mcmplt.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mcmplt_ew_x:
; CHECK: mcmplt.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mcmplt_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mcmplt.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}

declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mcolbcast.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mcolbcast_ew_x:
; CHECK: mcolbcast.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mcolbcast_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mcolbcast.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mcolshift.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mcolshift_ew_x:
; CHECK: mcolshift.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mcolshift_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mcolshift.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mbcast.m.x.triscv.ztt.matrix_i32_8_8t.i32.i32(target("riscv.ztt.matrix", i32, 8, 8), i32, i32)
; CHECK-LABEL: test_mbcast_m_x:
; CHECK: mbcast.m.x m0, a0, a1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mbcast_m_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, i32 %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mbcast.m.x.triscv.ztt.matrix_i32_8_8t.i32.i32(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, i32 %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare i32 @llvm.riscv.ztt.mgettyp.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mgettyp:
; CHECK: mgettyp a0, m0{{$}}
; CHECK-NEXT: ret{{$}}
define i32 @test_mgettyp(target("riscv.ztt.matrix", i32, 8, 8) %p0) {
  %r = call i32 @llvm.riscv.ztt.mgettyp.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0)
  ret i32 %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mhdiff.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mhdiff_ew_x:
; CHECK: mhdiff.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mhdiff_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mhdiff.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mldexp.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mldexp_ew_x:
; CHECK: mldexp.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mldexp_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mldexp.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mldexpacc.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mldexpacc_ew_x:
; CHECK: mldexpacc.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mldexpacc_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mldexpacc.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mlog2sub.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mlog2sub_ew_x:
; CHECK: mlog2sub.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mlog2sub_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mlog2sub.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mls.st.triscv.ztt.matrix_i32_8_8t.i32(target("riscv.ztt.matrix", i32, 8, 8), ptr, i32)
; CHECK-LABEL: test_mls_st:
; CHECK: mls.st m0, (a0), a1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mls_st(target("riscv.ztt.matrix", i32, 8, 8) %p0, ptr %p1, i32 %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mls.st.triscv.ztt.matrix_i32_8_8t.i32(target("riscv.ztt.matrix", i32, 8, 8) %p0, ptr %p1, i32 %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}

declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mls.tst.triscv.ztt.matrix_i32_8_8t.i32(target("riscv.ztt.matrix", i32, 8, 8), ptr, i32)
; CHECK-LABEL: test_mls_tst:
; CHECK: mls.tst m0, (a0), a1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mls_tst(target("riscv.ztt.matrix", i32, 8, 8) %p0, ptr %p1, i32 %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mls.tst.triscv.ztt.matrix_i32_8_8t.i32(target("riscv.ztt.matrix", i32, 8, 8) %p0, ptr %p1, i32 %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmax.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mmax_ew_x:
; CHECK: mmax.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mmax_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmax.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmean.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mmean_ew_x:
; CHECK: mmean.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mmean_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmean.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmin.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mmin_ew_x:
; CHECK: mmin.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mmin_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmin.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmove8.m.x.triscv.ztt.matrix_i32_8_8t.i32.i32(target("riscv.ztt.matrix", i32, 8, 8), i32, i32)
; CHECK-LABEL: test_mmove8_m_x:
; CHECK: mmove8.m.x m0, a0, a1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mmove8_m_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, i32 %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmove8.m.x.triscv.ztt.matrix_i32_8_8t.i32.i32(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, i32 %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}

declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmove16.m.x.triscv.ztt.matrix_i32_8_8t.i32.i32(target("riscv.ztt.matrix", i32, 8, 8), i32, i32)
; CHECK-LABEL: test_mmove16_m_x:
; CHECK: mmove16.m.x m0, a0, a1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mmove16_m_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, i32 %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmove16.m.x.triscv.ztt.matrix_i32_8_8t.i32.i32(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, i32 %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}

declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmove32.m.x.triscv.ztt.matrix_i32_8_8t.i32.i32(target("riscv.ztt.matrix", i32, 8, 8), i32, i32)
; CHECK-LABEL: test_mmove32_m_x:
; CHECK: mmove32.m.x m0, a0, a1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mmove32_m_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, i32 %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmove32.m.x.triscv.ztt.matrix_i32_8_8t.i32.i32(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, i32 %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}

declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmove64.m.x.triscv.ztt.matrix_i32_8_8t.i32.i32(target("riscv.ztt.matrix", i32, 8, 8), i32, i32)
; CHECK-LABEL: test_mmove64_m_x:
; CHECK: mmove64.m.x m0, a0, a1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mmove64_m_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, i32 %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmove64.m.x.triscv.ztt.matrix_i32_8_8t.i32.i32(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, i32 %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}

declare i32 @llvm.riscv.ztt.mmove8.x.m.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32)
; CHECK-LABEL: test_mmove8_x_m:
; CHECK: mmove8.x.m a0, m0, a0{{$}}
; CHECK-NEXT: ret{{$}}
define i32 @test_mmove8_x_m(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1) {
  %r = call i32 @llvm.riscv.ztt.mmove8.x.m.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1)
  ret i32 %r
}

declare i32 @llvm.riscv.ztt.mmove16.x.m.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32)
; CHECK-LABEL: test_mmove16_x_m:
; CHECK: mmove16.x.m a0, m0, a0{{$}}
; CHECK-NEXT: ret{{$}}
define i32 @test_mmove16_x_m(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1) {
  %r = call i32 @llvm.riscv.ztt.mmove16.x.m.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1)
  ret i32 %r
}

declare i32 @llvm.riscv.ztt.mmove32.x.m.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32)
; CHECK-LABEL: test_mmove32_x_m:
; CHECK: mmove32.x.m a0, m0, a0{{$}}
; CHECK-NEXT: ret{{$}}
define i32 @test_mmove32_x_m(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1) {
  %r = call i32 @llvm.riscv.ztt.mmove32.x.m.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1)
  ret i32 %r
}

declare i32 @llvm.riscv.ztt.mmove64.x.m.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32)
; CHECK-LABEL: test_mmove64_x_m:
; CHECK: mmove64.x.m a0, m0, a0{{$}}
; CHECK-NEXT: ret{{$}}
define i32 @test_mmove64_x_m(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1) {
  %r = call i32 @llvm.riscv.ztt.mmove64.x.m.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1)
  ret i32 %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmul.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mmul_ew_x:
; CHECK: mmul.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mmul_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmul.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmulacc.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mmulacc_ew_x:
; CHECK: mmulacc.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mmulacc_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmulacc.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmulaccneg.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mmulaccneg_ew_x:
; CHECK: mmulaccneg.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mmulaccneg_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmulaccneg.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmuladd.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mmuladd_ew_x:
; CHECK: mmuladd.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mmuladd_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmuladd.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmulneg.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mmulneg_ew_x:
; CHECK: mmulneg.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mmulneg_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmulneg.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmulsub.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mmulsub_ew_x:
; CHECK: mmulsub.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mmulsub_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mmulsub.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mor.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mor_ew_x:
; CHECK: mor.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mor_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mor.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mornot.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mornot_ew_x:
; CHECK: mornot.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mornot_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mornot.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}

declare target("riscv.ztt.matrix", i8, 8, 8) @llvm.riscv.ztt.mpack.ew.x.triscv.ztt.matrix_i8_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i8, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mpack_ew_x:
; CHECK: mpack.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i8, 8, 8) @test_mpack_ew_x(target("riscv.ztt.matrix", i8, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i8, 8, 8) @llvm.riscv.ztt.mpack.ew.x.triscv.ztt.matrix_i8_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i8, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mrowbcast.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mrowbcast_ew_x:
; CHECK: mrowbcast.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mrowbcast_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mrowbcast.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mrowshift.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mrowshift_ew_x:
; CHECK: mrowshift.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mrowshift_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mrowshift.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
; CHECK: msettyp m0, a0{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_msettyp(i32 %p0) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.msettyp.triscv.ztt.matrix_i32_8_8t.i32(target("riscv.ztt.matrix", i32, 8, 8) undef, i32 %p0)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.msll.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_msll_ew_x:
; CHECK: msll.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_msll_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.msll.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.msra.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_msra_ew_x:
; CHECK: msra.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_msra_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.msra.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.msrl.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_msrl_ew_x:
; CHECK: msrl.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_msrl_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.msrl.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare void @llvm.riscv.ztt.mss.st.triscv.ztt.matrix_i32_8_8t.i32(target("riscv.ztt.matrix", i32, 8, 8), ptr, i32)
; CHECK-LABEL: test_mss_st:
; CHECK: mss.st m0, (a0), a1{{$}}
; CHECK-NEXT: ret{{$}}
define void @test_mss_st(target("riscv.ztt.matrix", i32, 8, 8) %p0, ptr %p1, i32 %p2) {
  call void @llvm.riscv.ztt.mss.st.triscv.ztt.matrix_i32_8_8t.i32(target("riscv.ztt.matrix", i32, 8, 8) %p0, ptr %p1, i32 %p2)
  ret void
}

declare void @llvm.riscv.ztt.mss.tst.triscv.ztt.matrix_i32_8_8t.i32(target("riscv.ztt.matrix", i32, 8, 8), ptr, i32)
; CHECK-LABEL: test_mss_tst:
; CHECK: mss.tst m0, (a0), a1{{$}}
; CHECK-NEXT: ret{{$}}
define void @test_mss_tst(target("riscv.ztt.matrix", i32, 8, 8) %p0, ptr %p1, i32 %p2) {
  call void @llvm.riscv.ztt.mss.tst.triscv.ztt.matrix_i32_8_8t.i32(target("riscv.ztt.matrix", i32, 8, 8) %p0, ptr %p1, i32 %p2)
  ret void
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.msub.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_msub_ew_x:
; CHECK: msub.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_msub_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.msub.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.msublog2.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_msublog2_ew_x:
; CHECK: msublog2.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_msublog2_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.msublog2.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.munpack.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i8_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i8, 8, 8))
; CHECK-LABEL: test_munpack_ew_x:
; CHECK: munpack.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_munpack_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i8, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.munpack.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i8_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i8, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
...
declare target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mxor.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8), i32, target("riscv.ztt.matrix", i32, 8, 8))
; CHECK-LABEL: test_mxor_ew_x:
; CHECK: mxor.ew.x m0, a0, m1{{$}}
; CHECK-NEXT: ret{{$}}
define target("riscv.ztt.matrix", i32, 8, 8) @test_mxor_ew_x(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2) {
  %r = call target("riscv.ztt.matrix", i32, 8, 8) @llvm.riscv.ztt.mxor.ew.x.triscv.ztt.matrix_i32_8_8t.i32.triscv.ztt.matrix_i32_8_8t(target("riscv.ztt.matrix", i32, 8, 8) %p0, i32 %p1, target("riscv.ztt.matrix", i32, 8, 8) %p2)
  ret target("riscv.ztt.matrix", i32, 8, 8) %r
}
